...
// ✅ Define allowed recipients for sandbox mode
const allowedEmails = [
  "agnihotrisakshi256@gmail.com",
...
const sendEmail = async ({ sendTo, subject, html }) => {
  try {
    // 🚫 Block actual user emails in sandbox mode
    if (!allowedEmails.includes(sendTo)) {
      console.log(`Sandbox mode: email to ${sendTo} skipped`);
      return { skipped: true};
    }
